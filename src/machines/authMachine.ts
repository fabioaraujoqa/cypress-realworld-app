  ...
  },
  {
    services: {
      performSignup: async (ctx, event) => {
        ...
        const resp = await httpClient.post(`https://cypress-realworld-app-puce.vercel.app/users`, payload);
        history.push("/signin");
        return resp.data;
      },
      performLogin: async (ctx, event) => {
        return await httpClient
          .post(`https://cypress-realworld-app-puce.vercel.app/login`, event)
          .then(({ data }) => {
            history.push("/");
            return data;
          })
      ...
      getUserProfile: async (ctx, event) => {
        const resp = await httpClient.get(`https://cypress-realworld-app-puce.vercel.app/checkAuth`);
        return resp.data;
      },
      ...
      updateProfile: async (ctx, event: any) => {
        ...
        const resp = await httpClient.patch(
          `https://cypress-realworld-app-puce.vercel.app/users/${payload.id}`,
          payload
        );
        return resp.data;
      },
      performLogout: async (ctx, event) => {
        ...
        return await httpClient.post(`https://cypress-realworld-app-puce.vercel.app/logout`);
      },
